...
export class Login extends Component {
    ...
    validatePassword(password) {
        ...
        fieldValidationErrors.password = passwordValid ? '' : 'Password must be greater than 5 characters';
    ...
    render() {
        ...
        return (<div>
            ...
            <div className="center-child">
                <p className="center signin">Sign In</p>
                <form className="pure-form pure-form-stacked" onSubmit={this.onSubmit}>
                    <label className="left" htmlFor="email">Username</label>
                    <div className="validation-input">
                        ...
                        <span className={'checkmark ' + (formErrors.email.length > 0 ? '' : 'hide')}>
                    ...
                    <label className="left" htmlFor="password">Passcode</label>
                    <div className="validation-input">
                    <Tooltip
                        ...
                        >
                        <input id="password" name="password" className="password" type="password" value={password} onChange={this.onChange} />
                        </Tooltip>
                        ...
                        <span className={'checkmark ' + (formErrors.password.length > 0 ? '' : 'hide')}>
                            <div className="checkmark_circle_error"></div>
                            <div className="checkmark_stem_error"></div>
                            <div className="checkmark_kick_error"></div>
                        </span>
                    ...
                    <div className="center signin-gap">
                        <button type="submit" className="form-button center">Log in</button>
                        <label className="error-message">{serverErrors.join()}</label>
                    </div>
                </form>
                <div className="center register-gap">Don't have account? <span className="register"><Link to="/register">Register</Link></span></div>
            </div>
        </div>
        )
    }
