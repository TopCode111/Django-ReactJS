  ...
  return (
    <div>
      <div className="right language">
        ...
        {
          !auth.isAuthenticated && <span className="language"><Link to="login">SIGN IN</Link></span>
        }
        {
      ...
      <span className="language"><span>FR</span> / <span className="selected">EN</span></span>
      </div>
      <div className="landing-parent">
		...
		<img className='landing-icon' src="static/frontend/images/icon.png" />
          ...
          <span className="intro">Lorem ipsum dolor sit amet, consectetur
                  adipiscing elit, sed do eiusmod tempor
                  incididunt ut labore et dolore magna aliqua.
                Ut enim ad minim veniam.</span><br />
